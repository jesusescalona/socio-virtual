...
<html dir="ltr" lang="en">
	...
	<body class="no-trans front-page transparent-header  ">
		...
		<div class="page-wrapper">
			...
			<?php include ('files/whyChooseUs.php') ?>
			<?php include ('files/services.php') ?>
			<?php include ('files/ourOffers.php') ?>
			<?php include ('files/moreServices.php') ?>
			<?php include ('files/portfolio.php') ?>
			<?php include ('files/projects.php') ?>
